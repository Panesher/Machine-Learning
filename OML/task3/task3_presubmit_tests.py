...
def test_barrier_univariate():
    ...
    # x_ctar = np.array([-7.89796404e-07])
    # print(x_star, x_ctar)
    # print(np.allclose(
    #       x_star, x_ctar))
    # oracle = BarrierOracle(A, b, reg_coef, 1.)
    # print(oracles.lasso_duality_gap(x_star, A.dot(x_star) - b,
    #                                 A.T.dot(A.dot(x_star) - b), b, reg_coef),
    #       oracle.func(x_star), oracle.clear_func(x_star))
    # print(oracles.lasso_duality_gap(x_ctar, A.dot(x_ctar) - b,
    #                                 A.T.dot(A.dot(x_ctar) - b), b, reg_coef),
    #       oracle.func(x_ctar), oracle.clear_func(x_ctar))
